...
public class SongList {
	...
	public void scanSongs(Context c, String fromWhere) {
		...
		//  Java doesn't allow local static variables.
		if (scanningSongs)
			return;
		scanningSongs = true;
		...
		//
		// (note: using `IS_MUSIC!=0` takes a huge load of time)
    ...
    /**
     * 
     * @return  a list of playlist name
     */
	...
	/**
	 * @return a song object if exists , null otherwise
	 */
    ...
    //@return song objects of a desired playlist or Null
