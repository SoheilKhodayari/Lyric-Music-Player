...
public class ActivityMenuMain extends ActivityMaster
	...
	protected void onCreate(Bundle seventhSonOfASeventhSon) {
		...
		items.add(getString(R.string.menu_lyric));
		items.add(getString(R.string.menu_slyric));
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		else if(currentItem.equals(getString(R.string.menu_lyric))) {
			startActivity(new Intent(this,ActivityLyric.class));
		}
		else if(currentItem.equals(getString(R.string.menu_slyric))) {
			startActivity(new Intent(this,ActivityLyric.class));}
		else {
